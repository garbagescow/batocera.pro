...
BASE_URL=" https://github.com/garbagescow/batocera.pro/raw/main/webapps"
...
curl -L  https://github.com/garbagescow/batocera.pro/raw/main/webapps/Add-WebApp.sh -o /userdata/roms/webapps/+ADD-WEB-APPS.sh
...
curl -L  https://github.com/garbagescow/batocera.pro/raw/main/webapps/es_systems_webapps.cfg -o ~/configs/emulationstation/es_systems_webapps.cfg
